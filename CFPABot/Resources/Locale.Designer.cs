...
namespace CFPABot.Resources {
    ...
    public class Locale {
        ...
        /// <summary>
        ///   Looks up a localized string similar to 可以使用命令 `/mv &quot;projects/assets/{1}/{0}/{2}/&quot; &quot;projects/assets/{4}/{3}/{5}/&quot;` 来移动目录。.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to 可以在上面的链接中右方找到 About Project -&gt; Project ID 然后使用命令 `/add-mapping {0} [CURSEFORGE_PROJECT_ID]`. 如果路径有误则使用 `/mv &quot;projects/assets/{1}/[GAME_VERSION]/&quot; &quot;projects/assets/[NEW_DIR]/[GAME_VERSION]/&quot;`。.
        /// </summary>
